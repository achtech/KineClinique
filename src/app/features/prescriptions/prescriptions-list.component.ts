...
export class PrescriptionsListComponent implements OnInit, AfterViewInit {
  displayedColumns: string[] = ['id', 'patientId', 'prescriber', 'sessionsPrescribed', 'sessionsUsed', 'createdAt', 'documentUrl', 'actions'];
